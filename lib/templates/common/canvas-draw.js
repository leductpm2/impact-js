ig.module(
    ...
    // ig.canvasDraw.drawImage = function drawImage(ctx, systemScale, image, x, y, width, height, scale, offset) {
    //     if (typeof scale === 'undefined') scale = { x: 1, y: 1 };
    //     if (typeof offset === 'undefined') offset = { x: 0, y: 0 };
    //     if (typeof systemScale === 'undefined') systemScale = 1;
    ...
    //     ctx.save();
    //     ctx.translate(originX * systemScale, originY * systemScale);
